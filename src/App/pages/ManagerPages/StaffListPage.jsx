...
const StaffListPage = () => {
	...
	return (
		<Fragment>
			<SlideOver open={slideOverVisibility} onOpen={setSlideOverVisibility} panelTitle={"Thêm nhân viên"}>
				{/* Add student form */}
				<Form onSubmit={handleSubmit(onAddSubmit)}>
					...
					<SelectFieldControl label="Quyền hạn nhân viên" control={control} name="role" options={filterRole} />
					<Button type="submit" size="sm" variant="primary">
						Thêm
					</Button>
				</Form>
			</SlideOver>
			<Modal openState={modal} onOpenStateChange={setModal} title={"Sửa nhân viên"}>
				{user && (
					<Form onSubmit={handleSubmit(onUpdateSubmit)}>
						<InputFieldControl name="name" control={control} label="Tên nhân viên" defaultValue={user.name} />
						<InputFieldControl name="email" control={control} label="Email nhân viên" defaultValue={user.email} />
						<SelectFieldControl label="Quyền hạn nhân viên" control={control} name="role" options={filterRole} />
						<Button type="submit" size="sm" variant="primary">
							Lưu
						</Button>
